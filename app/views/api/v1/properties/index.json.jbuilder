json.all_properties @all_properties do |all_propertie|  
  json.(all_propertie, :id, :address, :city, :state, :zipcode, :latitude, :longitude, :unit, :id_number, :property_type)
...
json.user_properties @user_properties do |user_propertie|  
  json.(user_propertie, :id, :address, :city, :state, :zipcode, :latitude, :longitude, :unit, :id_number, :property_type)
